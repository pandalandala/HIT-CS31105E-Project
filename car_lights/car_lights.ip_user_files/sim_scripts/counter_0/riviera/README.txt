...
#
# Generated by export_simulation on Thu Dec 02 18:41:20 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './counter_0.sh' script.

./counter_0.sh -reset_run
...
./counter_0.sh -noclean_files

For more information on the script, please type './counter_0.sh -help'.
